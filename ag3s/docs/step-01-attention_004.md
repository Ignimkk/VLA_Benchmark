...
| 추론 프레임 | 44개 기록, **31개 채점** (13개 제외: target이 200 px 미만) |
...
가장 좋은 헤드는 **L7 h0** (Euler step 0, `last` pooling)입니다.
**peak-on-target 0.839** — head-average 0.129,
uniform 0.000 대비. 같은 물체에 균등 attention이 줄 밀도의
**25.70배**를 싣습니다. β = [0.0, 0.5, 1.0]에서 물체 단위 hit rate는
**0.161 / 0.258 / 1.000**.
...
|---|---|---|---|
| peak-on-target | 0.839 | 1 / 1296 | 16 |
| hit β=0 | 0.258 | 13 / 1296 | 9 |
| hit β=0.5 | 0.258 | 165 / 1296 | 9 |
| hit β=1 | 1.000 | 36 / 1296 | 32 |
...
0.323이므로 어떤 헤드가 낼 수 있는 최대 마진은
0.677입니다 — 아무것도 통과할 수 없는 게이트는 증거가
아니라 고장난 규칙입니다.
...
|---|---|---|---|---|---|---|---|
| head-average (all 18x8) | 0.032 | 0.161 | 0.323 | 0.129 | 0.007 | 4.25 | -0.040 |
| uniform (no model) | 0.000 | 0.000 | 0.000 | 0.000 | 0.001 | 1.00 | -0.034 |
| **best: L7 h0** | **0.161** | **0.258** | **1.000** | **0.839** | **0.032** | **25.70** | **-0.134** |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | L7 h0 | 0 | last | 0.161 | 0.258 | 1.000 | 0.839 | 0.032 | 25.70 | -0.134 |
| 2 | L7 h0 | 4 | last | 0.194 | 0.258 | 1.000 | 0.806 | 0.039 | 30.75 | -0.144 |
| 3 | L7 h0 | 4 | mean | 0.000 | 0.226 | 1.000 | 0.710 | 0.019 | 16.27 | -0.124 |
| 4 | L7 h0 | 9 | last | 0.129 | 0.226 | 1.000 | 0.613 | 0.020 | 16.42 | -0.088 |
| 5 | L7 h0 | 0 | mean | 0.000 | 0.194 | 1.000 | 0.484 | 0.017 | 15.00 | -0.117 |
| 6 | L2 h7 | 0 | last | 0.000 | 0.000 | 0.871 | 0.452 | 0.006 | 5.28 | -0.089 |
| 7 | L7 h6 | 9 | first | 0.000 | 0.000 | 0.581 | 0.323 | 0.005 | 4.17 | -0.069 |
| 8 | L8 h2 | 0 | mean | 0.226 | 0.258 | 0.710 | 0.258 | 0.065 | 38.63 | -0.051 |
| 9 | L8 h2 | 4 | mean | 0.226 | 0.258 | 0.839 | 0.258 | 0.061 | 36.99 | -0.107 |
| 10 | L8 h2 | 9 | last | 0.226 | 0.258 | 0.355 | 0.258 | 0.055 | 32.49 | -0.077 |
| 11 | L8 h7 | 0 | last | 0.226 | 0.258 | 0.323 | 0.258 | 0.044 | 25.30 | -0.017 |
| 12 | L8 h2 | 9 | mean | 0.194 | 0.258 | 0.484 | 0.258 | 0.039 | 23.44 | -0.079 |

![층·헤드별 peak-on-target](../asset/image_004/attention/fig1_layer_head_peak_on_target.png)

### attention이 실제로 어디로 가는가 (물체별)

| body | 평균 가시 픽셀 | attention mass | lift | argmax 획득 프레임 |
|---|---|---|---|---|
| crate | 10848 | 0.166 | 4.67 | 0 |
| apple | 373 | 0.032 | 25.70 | 31 |
| banana | 229 | 0.002 | 2.73 | 0 |
| orange | 492 | 0.003 | 1.85 | 0 |
| pear | 296 | 0.001 | 0.72 | 0 |
| table | 24185 | 0.091 | 1.14 | 0 |
| shelf | 0 | 0.000 | 0.00 | 0 |

![롤아웃 동안의 attention lift](../asset/image_004/attention/fig3_attention_lift.png)

### 프레임 자체

![attention overlay](../asset/image_004/attention/fig2_attention_overlay.png)

### 샘플링 선택이 결과를 바꾸는가

![choice sweep](../asset/image_004/attention/fig4_choice_sweep.png)
...
`attention[frame, 0, "last", 7, 0, camera]`이고,
...
MUJOCO_GL=osmesa src/openpi/.venv/bin/python -m benchmark.ag3s.experiments.record_check \
    --records outputs/rby1_atomic_infer/ag3s_step1/ag3s_records/run_0004

# 3. attention 추출 (GPU 서버, 체크포인트가 있는 곳)
python -m benchmark.ag3s.experiments.pi05_attention \
    --records outputs/rby1_atomic_infer/ag3s_step1/ag3s_records/run_0004 --checkpoint /mnt/dev/work/pi05_TO_hybrid/checkpoints/pi05_rby1_atomic_lora/rby1_atomic_basket_14d_v2_30k_20260825/29999 --out benchmark/ag3s/asset/data/attention_step1_run0004.npz
