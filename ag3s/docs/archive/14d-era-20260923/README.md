...
| 1 | [archive/step-verification-20260904/step-01-attention.md](../step-verification-20260904/step-01-attention.md) | π0.5가 프롬프트가 지목한 물체를 보는가 | MuJoCo 세그멘테이션 | **PASS** — L8 h2, peak-on-target 1.000 |
| 2 | [archive/step-verification-20260904/step-02-backprojection.md](../step-verification-20260904/step-02-backprojection.md) | 깊이 → 3D 점, 카메라 규약 | MuJoCo geom 자세·메시 정점 | **PASS** — 상판 높이 오차 0.7 mm 이내 |
| 3 | [archive/step-verification-20260904/step-03-lifting.md](../step-verification-20260904/step-03-lifting.md) | 2D attention → 3D 점 매핑 | 점별 body id | **PASS** — head peak 1.000, AUC 0.9998 |
| 4 | [archive/step-verification-20260904/step-04-grounding.md](../step-verification-20260904/step-04-grounding.md) | 클러스터링 + 채점이 target을 고르는가 | 물체별 point mask | **PASS** (파지 전) — 8/8, IoU 0.953 |
| 5 | [archive/step-verification-20260904/step-05-separation.md](../step-verification-20260904/step-05-separation.md) | target/obstacle 분리 후에도 기하가 남는가 | 후보 집합 vs 실제 물체 | **PASS** — 덮는 점 차이 0 |
| 6 | [archive/step-verification-20260904/step-06-geometry.md](../step-verification-20260904/step-06-geometry.md) | primitive 근사가 점을 포함하는가 | 포함 검사 + 실제 메시 | **부분 통과** — 관측 점 1.000 / 실제 물체 0.666 |
...
## 미해결 → [archive/primitive-era-20260904/OPEN-geometry-representation.md](../primitive-era-20260904/OPEN-geometry-representation.md)
...
위 표가 가리키는 단계별 검증 문서는 [`archive/step-verification-20260904/`](../step-verification-20260904/)
에 있다. 판정이 끝난 실험이고, 이후 검토는 [`AG3S_REVIEW_LOG.md`](../../AG3S_REVIEW_LOG.md) 의
Step 5–11 이 이어받았다. 무엇이 왜 옮겨졌는지는 [`archive/README.md`](../README.md) 에 있다.
