...
| 검사 | 결과 | 기준 |
|---|---|---|
| A. 관측 점 포함 | 통과 — 57개 후보 전부 포함률 1.000 | 전부 1.0 |
| B. **실제 물체 포함** | **실패** — 평균 **0.666**, 최대 침투 **46.7 mm** | 1.0 |
| C. 캡슐 구 체인 | 통과 — 실데이터 캡슐 47개 + 합성 4종 전부 100% 덮음 | 전부 1.0 |
...
|---|---|---|---|---|
| apple | 1.000 | 0.637 | 28.1 | 30 |
| banana | 1.000 | 0.859 | 18.8 | 20 |
| crate | 1.000 | 0.976 | 3.6 | 5 |
| orange | 1.000 | 0.498 | 14.6 | 15 |
| pear | 1.000 | 0.380 | 46.7 | 50 |
...
|---|---|---|---|
| apple | 47.1 | 21.4 | 1.0 |
| banana | 39.6 | 11.6 | 0.9 |
| crate | 161.5 | 71.4 | 1.4 |
...
|---|---|---|---|---|---|
| apple | 9 | 33.9 | 40.8 | 4.1 | **1.0000** |
| banana | 8 | 23.7 | 35.7 | 4.5 | **1.0000** |
| crate | 12 | 88.3 | 161.9 | 5.3 | **1.0000** |
| orange | 9 | 34.1 | 30.0 | 3.0 | **1.0000** |
| pear | 9 | 28.6 | 32.4 | 4.2 | **1.0000** |
...
풀지만, 도형이 실제 물체보다 최대 47 mm 작으므로 **실제 물체로부터의 여유는
3 mm까지 줄어들 수 있다.** 명목상의 여유거리 중 그만큼이 이미 도형의
과소 근사로 소진된 것이다.
