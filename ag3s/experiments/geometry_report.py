...
from benchmark.ag3s.geometry import (
...
def main() -> None:
    ...
    from benchmark.ag3s.experiments.grounding_report import build_robot_model, majority_body
    ...
    if example is not None:
        from benchmark.ag3s.experiments.cloud_gallery import _ax3d, fit_box, workspace_box
        from benchmark.ag3s.visualization import _wire_sphere
