...
from benchmark.ag3s.experiments.policy_record import CAMERA_BINDINGS, load_run, pose_scene, replay_scene
...
def main() -> None:
    ...
    from benchmark.ag3s.experiments.figstyle import sequential_cmap
