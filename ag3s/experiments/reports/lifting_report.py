...
from benchmark.ag3s.stages.attention_lifting import GridAttentionAdapter, lift, normalize_attention
...
def main() -> None:
    ...
    ap.add_argument("--out-doc", default="benchmark/ag3s/docs/archive/step-verification-20260904/step-03-lifting.md")
