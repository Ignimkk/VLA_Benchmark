...
실행::
    ...
    MPLCONFIGDIR=/tmp/ag3s-matplotlib MUJOCO_GL=osmesa \
      src/openpi/.venv/bin/python -m benchmark.ag3s.experiments.reports.observation_sdf_report \
...
from benchmark.ag3s.experiments.reports.esdf_report import extent_for, slice_index
