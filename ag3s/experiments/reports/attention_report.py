...
Run (locally, no GPU needed -- the forward pass already happened in `pi05_attention.py`):
    ...
    MUJOCO_GL=osmesa src/openpi/.venv/bin/python -m benchmark.ag3s.experiments.reports.attention_report \
        ...
        --out-doc benchmark/ag3s/docs/archive/step-verification-20260904/step-01-attention.md \
...
def main() -> None:
    ...
    ap.add_argument("--out-doc", default="benchmark/ag3s/docs/archive/step-verification-20260904/step-01-attention.md")
