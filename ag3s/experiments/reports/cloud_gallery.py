...
from benchmark.ag3s.stages.reconstruction import backproject, reconstruct
...
from benchmark.ag3s.stages.target_grounding import extract_seeds, ground_target
from benchmark.ag3s.runtime.visualization import _equalise, _thin, _wire_sphere
...
def main() -> None:
    ...
    if args.attention:
        ...
        from benchmark.ag3s.stages.attention_lifting import _resample
