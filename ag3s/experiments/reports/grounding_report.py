...
from benchmark.ag3s.experiments.reports.lifting_report import ROBOT_PREFIXES, category_of
...
def main() -> None:
    ...
    ap.add_argument("--out-doc", default="benchmark/ag3s/docs/archive/step-verification-20260904/step-04-grounding.md")
