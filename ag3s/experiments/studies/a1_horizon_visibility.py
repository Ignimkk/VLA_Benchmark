...
실행:
    MUJOCO_GL=osmesa PYTHONPATH=/mnt/dev/work .venv-ag3s/bin/python -m \
        benchmark.ag3s.experiments.studies.a1_horizon_visibility --records run_0004 --frames 15
"""
...
def main() -> None:
    ...
    from benchmark.ag3s.experiments.sources.mujoco_source import camera_observation, gaussian_attention
